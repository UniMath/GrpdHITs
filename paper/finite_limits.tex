...
$\sign$.  Finite limits in a bicategory include the biinitial object,
binary products, inserters and equifiers
\cite{power1991characterization}. Remember that the biinitial object
in $\alg(\sign)$ is the 1-truncated HIT for $\sign$, whose description
culminated in Construction~\ref{constr:hit_exist}. In this section we
discuss the other three kinds of limits.
