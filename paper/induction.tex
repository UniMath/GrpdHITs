...
\]
We refer to the formalization for details on the construction of paths
$\AlgPath{\TotalAlg Y}{j}$ and homotopies $\AlgHomot{\TotalAlg
Y}{j}$. The first projection $\TotalAlg Y \rightarrow X$ is a morphism
of algebras.
\end{definition}
