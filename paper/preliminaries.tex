...
\begin{definition}
Given biacategories $\B_1$ and $\B_2$ and a biadjucntion $L \dashv R$ with $L : \pseudo(\B_1, \B_2)$, we say that $L \dashv R$ is \fat{coherent} if the following equalities hold
\[
first coherency
\]
\[
