...
usually required to be univalent, meaning that isomorphism of objects
in a groupoid is equivalent to equality of objects. In this paper we
do not assume this requirement, so the groupoids in $\grpd$ are not
