...
\noLine
\TrinaryInfC{$\qquad h_1 : \homotendpoint{l}{r}{a_1}{a_2}{e_1}{e_2} \qquad h_2 : \homotendpoint{l}{r}{a_1}{a_2}{e_3}{e_4} \qquad$}
\UnaryInfC{$\hpair{h_1}{h_2} : \homotendpoint{l}{r}{a_1}{a_2}{\pair{e_1}{e_3}}{\pair{e_2}{e_4}}$}
\end{bprooftree}
\end{center}
...
\AxiomC{$x: X$}
\AxiomC{$e : \pathendpoint{A}{R}{T}$}
\QuaternaryInfC{$\hcompconst e : \homotendpoint{l}{r}{a_1}{a_2}{\comp{e}{\Ce x}}{\Ce x}$}
\end{bprooftree}
\end{center}
...
\begin{itemize}
	...
	Since there no arguments for this path constructor, we take $\homotpointarg[\torus] \eqdef \constantP{\unit}$ and $\pathargleft[\torus] \eqdef \pathargright[\torus] \eqdef \Ce(\unitt)$.
