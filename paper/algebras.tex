...
\QuaternaryInfC{$\hprl{h} : \homotendpoint{l}{r}{a_1}{a_2}{e_1}{e_2}, \quad \hprr{h} : \homotendpoint{l}{r}{a_1}{a_2}{e_3}{e_4}$}
\end{bprooftree}
\end{center}
...
\begin{center}
\begin{bprooftree}
\AxiomC{$e_l, e_r : \pathendpoint{A}{Q}{A}$}
\AxiomC{$h : \homotendpoint{l}{r}{a_1}{a_2}{e_l}{e_r}$}
\BinaryInfC{$\hap{h} : \homotendpoint{l}{r}{a_1}{a_2}{\comp{e_l}{\constr}}{\comp{e_r}{\constr}}$}
\end{bprooftree}
\end{center}
