...
\AxiomC{$e_3 : \pathendpoint{A}{T_1}{T_2}$}
\AxiomC{$h : \homotendpoint{l}{r}{a_1}{a_2}{e_1}{e_2}$}
\QuaternaryInfC{$\hap{h} : \homotendpoint{l}{r}{a_1}{a_2}{\comp{e_1}{e_3}}{\comp{e_2}{e_3}}$}
\end{bprooftree}
\end{center}
...
\QuaternaryInfC{$\hprl{h} \eqdef \hconcat{\hinv{\hpairprle}}{\hconcat{\hap h}{\hpairprle}} : \homotendpoint{l}{r}{a_1}{a_2}{e_1}{e_2}$}
\alwaysNoLine
\UnaryInfC{$\hprr{h} \eqdef \hconcat{\hinv{\hpairprre}}{\hconcat{\hap h}{\hpairprre}} : \homotendpoint{l}{r}{a_1}{a_2}{e_3}{e_4}$}
\end{bprooftree}
\end{center}
...
\begin{itemize}
	...
	\[
	\hap{(\hconcat{\hinv{\hlunitN}}{\hconcat{\hassocN}{\hconcat{\hap{(\hconstr{\unit}{\idENA})}}{\hconcat{\hinv{\hassocN}}{\hconcat{\hlunitN}{\hlunitN}}}}})}
	\]
	\[
