In this section, we discuss the free algebra for a signature $\sign$ and show that it gives rise to a left biadjoint pseudofunctor from 1-types to algebras for $\sign$.
