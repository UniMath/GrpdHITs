...
% rules for \initmor
\newcommand{\initmorid}[2]{\constructor{id}^{{\sim}}_{#1}(#2)}
\newcommand{\initmorinv}[2]{\constructor{inv}^{{\sim}}_{#1}(#2)}
\newcommand{\initmorcomp}[3]{\constructor{comp}^{{\sim}}_{#1}(#2,#3)}
\newcommand{\initmorinl}[2]{\constructor{inl}^{{\sim}}_{#1}(#2)}
\newcommand{\initmorinr}[2]{\constructor{inr}^{{\sim}}_{#1}(#2)}
\newcommand{\initmorpair}[3]{\constructor{pair}^{{\sim}}_{#1}(#2,#3)}
\newcommand{\initmorap}[2]{\constructor{ap}^{{\sim}}_{#1}(#2)}
\newcommand{\initmorpath}[2]{\constructor{path}^{{\sim}}_{#1}(#2)}
