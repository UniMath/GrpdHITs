...
a category. In the bicategory of 1-types, coinserter captures
precisely the notion of homotopy coequalizer \cite[Chapter
6]{hottbook}.
...
This section is dedicated to the construction of the coinserter in
...
g$. The \fat{coequifier} of $\beta$ and $\gamma$ is an object $Q$
